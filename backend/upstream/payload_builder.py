...
def build_chat_payload(
    ...
    if chat_type == "t2i":
        ...
        if chat_type in ("image_edit",) or (files and any("image" in str(f.get("file_type", "")).lower() for f in files)):
        ...
        extra_meta = {"subChatType": chat_type, "mode": chat_type}
